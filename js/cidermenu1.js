...
for (var i=0; i<= ciders.length-1; i++){
 ...
 var singleDrink='<tr> <td>' + ciders[i].fields.name + '</td> <td>' + ciders[i].fields.abv + '</td> </tr>';
...
for (var i=0; i<= meads.length-1; i++){
 ...
 var singleDrink='<tr> <td>' + meads[i].fields.name + '</td> <td>' + meads[i].fields.abv + '</td> </tr>';
...
for (var i=0; i<= wines.length-1; i++){
 ...
 var singleDrink='<tr> <td>' + wines[i].fields.name + '</td> <td>' + wines[i].fields.abv + '</td> </tr>';
...
for (var i=0; i<=  cocktail.length-1; i++){
 ...
 var singleDrink='<tr> <td>' + cocktail[i].fields.name + '</td> <td>' + cocktail[i].fields.abv + '</td> </tr>';
